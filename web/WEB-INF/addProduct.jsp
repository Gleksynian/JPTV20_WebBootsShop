...
<div class="w-100 d-flex justify-content-center">
    <form action="createAccountBox" method="POST" >
        <div class="card border-0 mb-3" style="width: 40em;">
            <h2 class="my-5 w-100 d-flex justify-content-center">Добавить обувь</h2>
            ...
            <div class="form-group">
                <label for="picture" class="form-label mt-4"></label>
            ...
            <div class="form-group">
                <label for="size" class="form-label mt-4">Размер</label>
